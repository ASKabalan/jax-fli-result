...
def generate_sample_cosmo_grid_catalog():
    ...
    catalog.to_parquet(
        "../results/sample_cosmogrid/catalog/cosmogrid_sample_lc.parquet"
    )

    stage3_path = "../../Simulations/CosmoGrid/stage3_forecast/cosmo_000001/perm_0000/"
    stage3_catalog = jfli.io.load_cosmogrid_kappa(stage3_path)
    stage3_catalog.to_parquet(
        "../results/sample_cosmogrid/catalog/cosmogrid_sample_kappa.parquet"
    )
